...
class job_shop_env():
    def __init__(self):
        f = open("C:/Users/banana/Desktop/RFCODE/ft06.txt", 'r', encoding = 'utf-8-sig')
        x = f.readlines()
        f.close()
...
for i in range(100):
    ...
    while(True):
        ...
        if abs(pre - ot ) <10 :
            ...
            r = 1/abs(pre - ot )+r
        opt = SharedAdam(enet.parameters(), lr=0.00001) 
...
#torch.save(net.state_dict(), "model6X6.tc")
job2 = job_shop_env()
timmmer = []
