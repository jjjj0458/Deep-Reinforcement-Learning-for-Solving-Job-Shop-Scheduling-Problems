...
class job_shop_env():
    def __init__(self):
        f = open("C:/Users/banana/Desktop/RFCODE/la02.txt", 'r', encoding = 'utf-8-sig')
        x = f.readlines()
        f.close()
...
for i in range(50):
    ...
    while(True):
        ...
        if abs(pre - ot ) == 0 :
            ...
            r = 20/abs(pre - ot )+r
        opt = SharedAdam(net.parameters(), lr=0.000001) 
...
torch.save(net.state_dict(), "model10X5.tc")
job2 = job_shop_env()
#
